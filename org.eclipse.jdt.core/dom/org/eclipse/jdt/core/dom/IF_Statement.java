...
public class IF_Statement extends Statement {
	...
	public static final ChildPropertyDescriptor EXPRESSION_PROPERTY =
		new ChildPropertyDescriptor(IF_Statement.class, "expression", Expression.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
	...
	public static final ChildPropertyDescriptor THEN_STATEMENT_PROPERTY =
		new ChildPropertyDescriptor(IF_Statement.class, "thenStatement", Statement.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
	...
	public static final ChildPropertyDescriptor ELSE_STATEMENT_PROPERTY =
		new ChildPropertyDescriptor(IF_Statement.class, "elseStatement", Statement.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
	...
	static {
		...
		createPropertyList(IF_Statement.class, properyList);
	...
	ASTNode clone0(AST target) {
		IF_Statement result = new IF_Statement(target);
